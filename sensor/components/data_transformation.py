...
class DataTransformation:
    """
    Desciption:
        This class helps in data transformation operations, like scaling, imputing, handling data imbalance.
    """
    ...
    def get_data_transformer_object(cls)->Pipeline:
        ...
        try:
            ...
            logging.info(msg ="Data Pre-processing pipeline get initiated.")
            return preprocessor
        except Exception as e:
